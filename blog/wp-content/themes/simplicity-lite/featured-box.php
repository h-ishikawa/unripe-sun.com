...
<p><?php echo esc_textarea(simplicity_get_option('featured-description' . $fboxn , 'The Color changing options of Simplicity will give the WordPress Driven Site an attractive look. Simplicity is super elegant and Professional Responsive Theme which will create the business widely expressed.')); ?></p>
</span>
...
<div class="clear"> </div>
<p><?php echo esc_textarea(simplicity_get_option('featured-description2' . $fboxn2 , 'Simplicity is super elegant and Professional Responsive Theme which will create the business widely expressed.')); ?></p>
</span>
