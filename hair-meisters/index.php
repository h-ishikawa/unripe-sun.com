...
<body class="menus">
  <div class="header">
    <div id="header" class="container">
      <? require_once('../partials/hair-meisters/header.php') ?>
    </div>
  </div>
  ...
  <div class="contents">
    <div id="contents" class="container">
      ...
      <div class="menu">
          <h3>【ヘアマイスター】</h3>
          <p>ヘアマイスターはヘア知識が豊富で、お客様の毛髪診断が正しく判断し、それに対する処置・アドバイスが的確に出来る人です。厳正なる4段階の認定試験にすべて合格した人にのみ贈られる舞踊業界において名誉と権威のある称号です。</p>
        </div>
